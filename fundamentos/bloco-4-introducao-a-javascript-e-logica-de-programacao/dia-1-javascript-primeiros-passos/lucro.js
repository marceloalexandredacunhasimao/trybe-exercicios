...
/*
    ...
    de lucro (valor de venda descontado o custo do produto) a empresa terá ao vender mil
    desses produtos.
...
const valorCusto=20;
const valorVenda=30;
let lucro,impostoSobreOCusto;

if(valorCusto<0 || valorVenda<0 )console.log("Erro: valor negativo!");
else{
    impostoSobreOCusto=imposto*valorCusto;
    valorCustoTotal = valorCusto + impostoSobreOCusto;
