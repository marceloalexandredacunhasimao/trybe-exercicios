...
// 3. Crie uma função que, ao digitar na caixa de texto, altere o texto do elemento
// com a classe 'tech';
function escreveNaClasseTech(event)
{
    let ondeEscrever=document.querySelector('.tech');
    ondeEscrever.innerText=event.target.value;
}
input.addEventListener('input',escreveNaClasseTech);
...
{
    window.location.replace('https://marceloalexandredacunhasimao.github.io/');
});
...
/*function mudaCorDoElement(event)
{
    event.target.style.color='red';
}
*/